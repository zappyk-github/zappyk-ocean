...
################################################################################
                    ...
                    DELUGE_DAEMON_RUN="cd $DELUGE_BASE && nohup $DELUGE_DAEMON_CMD >$DELUGE_DAEMON_LOG 2>&1 &"
...
################################################################################
                    ...
                    DELUGE_WEB_RUN="cd $DELUGE_BASE && nohup $DELUGE_WEB_CMD >$DELUGE_WEB_LOG 2>&1 &"
...
################################################################################
                    ...
                    DELUGE_MOVE_RUN="cd $DELUGE_BASE && nohup $DELUGE_MOVE_CMD >$DELUGE_MOVE_LOG 2>&1 &"
